function predicted_categories = NLsvm_classify(train_image_feats, ...
...
for i=1:cat_N
    ...
    dataset = vl_homkermap(train_image_feats', 1, 'kchi2', 'gamma', .5) ;
    [w, b, ~] = vl_svmtrain(dataset, y', lambda, ...
        'MaxNumIterations', iterations, ...
         'loss', 'LOGISTIC', ...
        'epsilon', 0.0001 );
    % get the score
    dataset2 =  vl_homkermap(test_image_feats', 1, 'kchi2', 'gamma', .5) ;
    scores(:,i) = (w'*(dataset2)) + b' ;
end
